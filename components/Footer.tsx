...
const Footer = () => {
  ...
  const translations = {
    sq: {
      brandDesc: "Një mjedis i ngrohtë, edukues dhe i sigurt për fëmijët që nga viti 2009. Prioriteti ynë është mirëqenia dhe zhvillimi i çdo fëmije.",
      navTitle: "Navigimi",
      contactTitle: "Na Kontaktoni",
      address: "Rr. Gramoz Pashko, Tiranë",
      ctaTitle: "Vizitoni Qendrën",
      ctaSchedule: "Orari: E hënë – E premte",
      ctaNote: "Vizitat bëhen vetëm me rezervim",
      ctaBtn: "REZERVO TAKIM",
      rights: `© {year} Qendra M.I.K.E. Të gjitha të drejtat të rezervuara.`,
      privacy: "Politika e Privatësisë",
      terms: "Termat e Përdorimit",
      links: [
    ...
    en: {
      brandDesc: "A warm, nurturing, and safe environment for children since 2009. Our absolute priority is the well-being and development of every child.",
      navTitle: "Navigation",
      contactTitle: "Contact Us",
      address: "Gramoz Pashko St., Tirana",
      ctaTitle: "Visit the Center",
      ctaSchedule: "Hours: Monday – Friday",
      ctaNote: "Visits are by appointment only",
      ctaBtn: "BOOK A MEETING",
      rights: `© {year} M.I.K.E Center. All rights reserved.`,
      privacy: "Privacy Policy",
      terms: "Terms of Use",
      links: [
        { name: "About Us", href: "/rreth-nesh" },
        { name: "Gallery", href: "/galeri" },
        { name: "Staff", href: "/stafi" },
        { name: "Projects", href: "/projektet" },
        { name: "Services", href: "/sherbimet" }
      ]
    }
  };
    ...
    <footer className="bg-white pt-20 pb-10 border-t border-gray-100">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              {/* Facebook */}
              <a 
                href="https://www.facebook.com/qendramiketirane/" 
                target="_blank"
              ...
              {/* Instagram */}
              <a 
                href="https://www.instagram.com/qendra_mike/" 
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gray-50 rounded-full flex items-center justify-center text-mikePurple hover:bg-mikePurple hover:text-white transition-all shadow-sm"
          ...
          {/* Quick Links Column */}
          <div>
            <h4 className="text-lg font-black text-mikeDark mb-6 uppercase tracking-wider text-sm">{t.navTitle}</h4>
          ...
          {/* Contact Info Column */}
          <div>
            <h4 className="text-lg font-black text-mikeDark mb-6 uppercase tracking-wider text-sm">{t.contactTitle}</h4>
          ...
          <div>
            <div className="bg-purple-50 p-8 rounded-[2.5rem] border border-purple-100">
              <h4 className="text-mikePurple font-black mb-4">{t.ctaTitle}</h4>
        ...
        <div className="pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-bold text-gray-400 uppercase tracking-widest">
          <p>{t.rights.replace('{year}', currentYear.toString())}</p>
          <div className="flex gap-8">
            <a href="#" className="hover:text-mikePurple">{t.privacy}</a>
            <a href="#" className="hover:text-mikePurple">{t.terms}</a>
          </div>
        </div>
      </div>
    </footer>

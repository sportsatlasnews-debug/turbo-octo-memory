...
const ProjectsPage = () => {
  // Të dhënat zyrtare të përkthyera plotësisht në Shqip
  const projectsData = [
    { 
      id: 1, 
      emri: "Përditësimi dhe ofrimi i modulit të trajnimit për stafin e vlerësimit të aftësisë së kufizuar, mjekët e familjes, mjekët specialistë dhe administratorët socialë mbi zbatimin e reformës së vlerësimit të aftësisë së kufizuar në të gjitha njësitë administrative të Bashkisë Tiranë", 
    ...
    { 
      id: 4, 
      emri: "Ngritja e kapaciteteve të grupeve multidisiplinare në zonat e tilla rurale të thella në rajonet e Tiranës dhe Durrësit për identifikimin, trajtimin dhe këshillimin e personave me aftësi të kufizuara (përfshirë të moshuarit)", 
      donatori: "🏛 AMSHC", 
        ...
        <div className="mb-16 bg-gradient-to-br from-mikeDark to-purple-950 text-white rounded-[2.5rem] p-8 md:p-12 shadow-xl relative overflow-hidden group">
          ...
          <div className="relative z-10 max-w-4xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 border-t border-white/10 pt-6 text-left">
              ...
              <div>
                <span className="block text-[10px] uppercase tracking-wider text-purple-300 font-bold">Fokusi</span>
